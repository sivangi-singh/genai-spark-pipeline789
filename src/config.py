...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.default_customers: int = 100_000
        self.default_products: int = 10_000
        self.default_orders: int = 1_000_000
        ...
        # File formats
        self.output_format: str = "parquet"  # Options: csv, json, parquet
